    ...
    <div class="btn-group ">
        ...
        <ul class="dropdown-menu">
            @if($review->status == 'pending')
                <li>
                    <a class="dropdown-item confirm-action" href="{{ route('user.reviews.moderation.change-status', [$review, 'published']) }}" data-method="PUT">
                        {{ trans('Publish') }}
                    </a>
                </li>
            @elseif($review->status == 'published')
                <li>
                    <a class="dropdown-item confirm-action" href="{{ route('user.reviews.moderation.change-status', [$review, 'rejected']) }}" data-method="PUT">
                        {{ trans('Reject') }}
                    </a>
                </li>
