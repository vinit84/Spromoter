...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card h-100">
                <div class="card-header header-elements">
                    <span class="me-2">{{ trans('Earning Reports') }}</span>

                    @can('invoice-read')
                        <div class="card-header-elements ms-auto">
                            <a href="{{ route('admin.business.invoices.index') }}"
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4 d-flex flex-column align-self-end">
                            <div class="d-flex gap-2 align-items-center mb-2 pb-1 flex-wrap">
                                <h1 class="mb-0">{{ Number::currency($earningReportTotalEarning) }}</h1>
                                @if($earningReportIsEarningPositive)
                                    <div class="badge rounded bg-label-success">
                                        <i class="ti ti-arrow-up ti-xxs"></i>
                                        {{ Number::percentage($earningReportEarningPercentage) }}
                                    </div>
                                @elseif($earningReportIsEarningPositive < 0)
                                    <div class="badge rounded bg-label-danger">
                                        <i class="ti ti-arrow-down ti-xxs"></i>
                                        {{ Number::percentage($earningReportEarningPercentage) }}
                                    </div>
                                @else
                                    <div class="badge rounded bg-label-secondary">
                                        <i class="ti ti-arrows-up-down ti-xxs"></i>
                                        {{ Number::percentage($earningReportEarningPercentage) }}
                                    </div>
                                @endif
                            </div>
                            <small>{{ trans('You informed of this week compared to last week') }}</small>
                        </div>
                        <div class="col-12 col-md-8">
                            <div
                                id="weeklyEarningReports"
                            ></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-header header-elements">
                    <span class="me-2">{{ trans('Support Tracker') }}</span>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-4 col-md-12 col-lg-4">
                            <div class="mt-lg-4 mt-lg-2 mb-lg-4 mb-2 pt-1">
                                <h1 class="mb-0">{{ Number::abbreviate($supportTrackerTotalTickets) }}</h1>
                                <p class="mb-0">{{ trans('Total Tickets') }}</p>
                            </div>
                            <ul class="p-0 m-0">
                                <li class="d-flex gap-3 align-items-center mb-lg-3 pt-2 pb-1">
                                    ...
                                    <div>
                                        <h6 class="mb-0 text-nowrap">{{ trans('New Tickets') }}</h6>
                                        <small
                                            class="text-muted">{{ Number::abbreviate($supportTrackerNewTickets) }}</small>
                                    </div>
                                </li>
                                <li class="d-flex gap-3 align-items-center mb-lg-3 pb-1">
                                    ...
                                    <div>
                                        <h6 class="mb-0 text-nowrap">{{ trans('Open Tickets') }}</h6>
                                        <small
                                            class="text-muted">{{ Number::abbreviate($supportTrackerOpenTickets) }}</small>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div class="col-12 col-sm-8 col-md-12 col-lg-8">
                            <div id="supportTracker"
                                 data-closed-tickets="{{ $supportTrackerAverageClosedTickets }}"></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <ul class="p-0 m-0">
                        ...
                        <li class="mb-4 pb-1 d-flex justify-content-between align-items-center">
                            <div class="badge bg-label-secondary rounded p-2">
                                <i class="ti ti-alert-triangle-triangle ti-sm text-body"></i>
                            </div>
                            <div class="d-flex justify-content-between w-100 flex-wrap">
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/pages/cards-advance.css') }}"/>
@endpush
...
@push('pageScripts')
    <script>
        window.weeklyEarningDays = @json($earningReportChartData->keys());
        window.weekylyEarningAmounts = @json($earningReportChartData->values());
    </script>
    <script src="{{ asset('assets/js/page/user/dashboard/index.js') }}"></script>
@endpush
