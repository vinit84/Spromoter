                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-4 mt-3">
                        ...
                        <li class="d-flex align-items-center mb-3">
                            ...
                            ><span class="fw-medium mx-2 text-heading">{{ trans('Status:') }}</span>
                            <span>{{ str($user->status)->title() }}</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                    ...
                    <ul class="list-unstyled mb-4 mt-3">
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-mail"></i><span class="fw-medium mx-2 text-heading">{{ trans('Email:') }}</span>
                            <span>{{ $user->email }}</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-phone-call"></i><span class="fw-medium mx-2 text-heading">{{ trans('Phone:') }}</span>
                            <span>{{ $user->phone }}</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-brand-skype"></i><span class="fw-medium mx-2 text-heading">{{ trans('Skype:') }}</span>
                            <span>{{ $user->social_skype }}</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-brand-twitter"></i><span class="fw-medium mx-2 text-heading">{{ trans('Twitter:') }}</span>
                            <span>{{ $user->social_twitter }}</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-brand-facebook"></i><span class="fw-medium mx-2 text-heading">{{ trans('Facebook:') }}</span>
                            <span>{{ $user->social_facebook }}</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-brand-linkedin"></i><span class="fw-medium mx-2 text-heading">{{ trans('Linkedin:') }}</span>
                            <span>{{ $user->social_linkedin }}</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="ti ti-brand-instagram"></i><span class="fw-medium mx-2 text-heading">{{ trans('Instagram:') }}</span>
