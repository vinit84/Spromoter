        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
                    ...
                    <li class="dropdown-notifications-list scrollable-container">
                        <div class="list-group list-group-flush">
                            @foreach($notifications as $notification)
                                <a href="{{ route('user.notifications.visit', $notification->id) }}" @class(['list-group-item list-group-item-action dropdown-notifications-item', 'mark-as-read' => $notification->read_at])>
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3">
                                            <div class="avatar">
                                            <span @class(['avatar-initial rounded-circle', ($notification->data['type'] ?? 'success') == 'error' ? 'bg-label-danger' : 'bg-label-success'])>
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <a class="dropdown-item" href="{{ route('user.profile.security.index') }}">
                            <i class="ti ti-shield-cog me-2 ti-sm"></i>
                            <span class="align-middle">{{ trans('Security') }}</span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="{{ route('user.profile.api-keys.index') }}">
                            <i class="ti ti-api me-2 ti-sm"></i>
                            <span class="align-middle">{{ trans('API Key') }}</span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="{{ route('user.integrations.index') }}">
                            <i class="ti ti-plug-connected me-2 ti-sm"></i>
                            <span class="align-middle">{{ trans('Integrations') }}</span>
                        </a>
                    </li>
                    <li>
                        <div class="dropdown-divider"></div>
