(function ($, DataTable) {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: function (dt) {
            return '<i class="ti ti-file-spreadsheet me-0 me-sm-1 ti-xs"></i> ' + dt.i18n('buttons.excel', 'Excel');
        },
    ...
    DataTable.ext.buttons.postExcelVisibleColumns = {
        ...
        text: function (dt) {
            return '<i class="ti ti-file-spreadsheet me-0 me-sm-1 ti-xs"></i> ' + dt.i18n('buttons.excel', 'Excel (only visible columns)');
        },
    ...
    DataTable.ext.buttons.export = {
        extend: 'collection',
        className: 'buttons-export btn-label-secondary',

        text: function (dt) {
            return '<i class="ti ti-screen-share me-1 ti-xs"></i> ' + dt.i18n('buttons.export', 'Export') + '&nbsp;<span class="caret"/>';
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: function (dt) {
            return '<i class="ti ti-file me-0 me-sm-1 ti-xs"></i> ' + dt.i18n('buttons.csv', 'CSV');
        },
    ...
    DataTable.ext.buttons.postCsvVisibleColumns = {
        ...
        text: function (dt) {
            return '<i class="ti ti-file me-0 me-sm-1 ti-xs"></i> ' + dt.i18n('buttons.csv', 'CSV (only visible columns)');
        },
    ...
    DataTable.ext.buttons.postCsv = {
        ...
        text: function (dt) {
            return '<i class="ti ti-file-type-csv me-0 me-sm-1 ti-xs"></i> ' + dt.i18n('buttons.csv', 'CSV');
        },
    ...
    DataTable.ext.buttons.pdf = {
        ...
        text: function (dt) {
            return '<i class="ti ti-pdf me-0 me-sm-1 ti-xs"></i> ' + dt.i18n('buttons.pdf', 'PDF');
        },
    ...
    DataTable.ext.buttons.print = {
        ...
        text: function (dt) {
            return  '<i class="ti ti-printer me-0 me-sm-1 ti-xs"></i> ' + dt.i18n('buttons.print', 'Print');
        },
    ...
    DataTable.ext.buttons.create = {
        className: 'buttons-create btn-primary',

        text: function (dt) {
            return '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i> ' + dt.i18n('buttons.create', 'Create');
        },
