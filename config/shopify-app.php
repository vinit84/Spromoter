...
return [
    ...
    */
    ...
    'api_key' => env('SHOPIFY_API_KEY', 'c94f8ea02e272286f09cf364cbcae5c6s'),
    ...
    */
    ...
    'api_secret' => env('SHOPIFY_API_SECRET', '63bdddee4cfed7c526875578ba6975a9'),
    ...
    */
    ...
    //     */],
        ...
        [
            'topic' => env('SHOPIFY_WEBHOOK_1_TOPIC', 'ORDERS_CREATE'),
            'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'http://spromoter.test/webhook/orders-create')
        ],
    ],
    ...
    */
    'scripttags' => [
        [
            'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', 'http://spromoter.test/scripttag/js-method-response'),
