...
namespace App\DataTables\User\Reviews;
...
class ModerationDataTable extends DataTable
{
                    ...
                    'buttons' => [
                        Button::raw([
                            ...
                            'attr' => [
                                ...
                                'href' => route('user.reviews.moderation.bulk-publish', $this->store->id),
                                'id' => 'bulk-publish',
                                'data-method' => 'PUT'
                            ]
                        ]),
                        Button::raw([
                            ...
                            'attr' => [
                                'title' => trans('Publish Selected Reviews'),
                                'href' => route('user.reviews.moderation.bulk-reject', $this->store->id),
                                'id' => 'bulk-reject',
                                'data-method' => 'PUT'
                            ]
                        ])
            ...
            ->parameters([
                'initComplete' => 'function () {
                    ...
                    $(".reply-status").on("change", function() {
                        ...
                        let $this = $(this);
                        $.ajax({
                            url: route("user.reviews.moderation.comment.change-status", { store: ' . $this->store->id . ', review: id }),
                            method: "PUT",
    ...
    {
        return to_route('user.reviews.export.create', ['type' => 'xlsx']);
    }

    public function csv()
    {
        return to_route('user.reviews.export.create', ['type' => 'csv']);
    }
